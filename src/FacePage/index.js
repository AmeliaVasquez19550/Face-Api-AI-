        ...
        if (this.isModelLoaded()!==undefined){
            try{
                ...
                //ADD CANVAS
                    ...
                    base_image.src = 'https://image.flaticon.com/icons/svg/744/744519.svg';//svgsilh.com/svg/306909.svg'*/;
                    base_image.onload = function(){

                        canvasElement.drawImage(base_image, result.landmarks.positions[36].x-25, 
                                                    /*Posición de los lentes*/
                             result.landmarks.positions[30].y-,490,390);
                        }

                    let base_bigote = new Image();
                    base_bigote.src = 'https://image.flaticon.com/icons/png/512/725/725081.png'/*'https://svgsilh.com/svg/306909.svg'*/;
